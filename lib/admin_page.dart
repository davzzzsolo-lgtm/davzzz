...
class _AdminPageState extends State<AdminPage> with SingleTickerProviderStateMixin {
  ...
  final Color cardBlack = const Color(0xFF2A0000);
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://draoffice.danzxnhosting.my.id:11860/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://draoffice.danzxnhosting.my.id:11860/deleteUser?key=$sessionKey&username=$username'),
      );
  ...
  Future<void> _createAccount() async {
    ...
    try {
      final url = Uri.parse(
        'http://draoffice.danzxnhosting.my.id:11860/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole',
      );
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [deepPurple, const Color(0xFF120000)],
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              dropdownColor: const Color(0xFF2A0000),
              value: selectedRole,
              isExpanded: true,
  ...
  Widget _buildUserItem(Map user) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Color(0xFF120000).withOpacity(0.5), blurRadius: 5, offset: const Offset(0, 2))
        ],
      ),
      child: Row(
        children: [
  ...
  Widget _buildDropdown(String val, Function(String?) onChanged) {
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          dropdownColor: const Color(0xFF3D0000),
          value: val,
          isExpanded: true,
